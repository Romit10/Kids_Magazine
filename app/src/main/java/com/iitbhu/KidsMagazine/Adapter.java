...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    private String[] sContentBeng;
    private String[] sContentKnd;
    private int flag;

    Adapter(HomeActivity context, String[] titles, String[] contents,String[] contentsBeng,String[] contentsKnd,int flag){
        this.inflater = LayoutInflater.from(context);
        this.sTitles = titles;
        this.sContent = contents;
        this.sContentBeng =contentsBeng;
        this.sContentKnd=contentsKnd;
        this.flag = flag;
    }
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra("contentOfStoryBeng",sContentBeng[getAdapterPosition()]);
                    i.putExtra("contentOfStoryKnd",sContentKnd[getAdapterPosition()]);
                    i.putExtra("key",flag);
